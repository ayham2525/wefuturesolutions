        ...
        <div class="row">
            <div class="col-md-6">
                <div class="content">
                    ...
                    <a class="learn-more" href="<?php echo $link['url'];?>" target="<?php echo $link['target'];?>">
                        <?php echo $link['title']; ?>
            ...
            <div class="col-md-6">
                <div class="illustration text-center">
                    ...
                    <?php
                        ...
                        $img = $image_src[0];
                    ?>
                    <img class="img-fluid" src="<?php echo esc_url($img); ?>" alt="<?php echo esc_attr(get_sub_field('title')); ?>">
                    <?php endif; ?>
                </div>
            </div>
        </div>
