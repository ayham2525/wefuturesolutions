...
<section class="single_title_and_text_section py-4">
    <div class="container">
        <div class="row">
            <div class="col-12">
                <?php if(get_sub_field('title')):?>
                    <h1 class="title py-2"><?php echo get_sub_field('title');?></h1>
                <?php endif;?>
                 <?php if(get_sub_field('text')):?>
                    <div class="text py-2"><?php echo get_sub_field('text');?></div>
                <?php endif;?>
